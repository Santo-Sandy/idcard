...
class ProductionPdfExporter {
  ...
  static Future<String> exportSingleCard(Student student) async {
    ...
    return _saveFile(pdf, "student_id_card.pdf");
  }

  static Future<String> exportMultipleCardsA4(List<Student> students) async {
    final pdf = pw.Document();
    final fonts = await _loadFonts();
    final logo = await _loadLogo();
    ...
    return _saveFile(pdf, "student_id_cards_a4.pdf");
  }
  ...
  static Future<String> _saveFile(pw.Document pdf, String fileName) async {
